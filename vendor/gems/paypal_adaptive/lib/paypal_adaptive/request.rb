...
module PaypalAdaptive
  ...
  class Request
    ...
    def add_bank_account(data)
      wrap_post(data, "/AdaptiveAccounts/AddBankAccount")
    end

    def add_payment_card(data)
      wrap_post(data, "/AdaptiveAccounts/AddPaymentCard")
    end
    ...
    def get_user_agreement(data)
      wrap_post(data, "/AdaptiveAccounts/GetUserAgreement")
    end
    ...
    def set_funding_source_confirmed(data)
      wrap_post(data, "/AdaptiveAccounts/SetFundingSourceConfirmed")
    end



    # Common POSTing methods
